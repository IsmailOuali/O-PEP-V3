    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            <form action="#" method="post">
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div>
                        ...
                        <select id="category"
                            ...
                            <option value="TV">Décoration</option>
                            <option value="PC">Médicinale</option>
                            <option value="GA">Agricole</option>
                        </select>
                    </div>
                    <div class="sm:col-span-2">
                ...
                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold mt-5 py-2 px-4 rounded-full">
                    Add product
                </button>
            </form>
        </div>
